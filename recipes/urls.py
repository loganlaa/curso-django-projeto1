...
urlpatterns = [
    ...
    path('recipes/<int:id>/', views.recipe, name="recipe"), #Recebe o parametro "id" ao acionar a view, que é passado com ela junto com a request, deixando a url dinamica
]
